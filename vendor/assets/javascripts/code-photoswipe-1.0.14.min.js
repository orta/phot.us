...
bodyWidth:function(){return a.DOM.width(document.body)},bodyHeight:function(){return a.DOM.height(document.body)},windowWidth:function(){return f.innerWidth},windowHeight:function(){return f.innerHeight},windowScrollLeft:function(){return f.pageXOffset},windowScrollTop:function(){return f.pageYOffset}}})})(window,Code.PhotoSwipe.Util);
(function(f,a){a.extend(a,{Events:{add:function(a,c,d){this._checkHandlersProperty(a);typeof a.__eventHandlers[c]==="undefined"&&(a.__eventHandlers[c]=[]);a.__eventHandlers[c].push(d);this._isElement(a)&&a.addEventListener(c,d,!1)},remove:function(b,c,d){this._checkHandlersProperty(b);if(b.__eventHandlers[c]instanceof Array){var e,f=b.__eventHandlers[c];if(a.isNothing(d)){if(this._isElement(b))for(e=0;e<f.length;e++)b.removeEventListener(c,f[e],!1);b.__eventHandlers[c]=[]}else{e=0;for(var g=f.length;e<
g;e++)if(f[e]===d){f.splice(e,1);break}this._isElement(b)&&b.removeEventListener(c,d,!1)}}},fire:function(a,c){var d,e,h=Array.prototype.slice.call(arguments).splice(2);if(this._isElement(a)){if(typeof c!=="string")throw"type must be a string for DOM elements";e=this._NATIVE_EVENTS[c];d=document.createEvent(e?"HTMLEvents":"UIEvents");d[e?"initEvent":"initUIEvent"](c,!0,!0,f,1);if(h.length<1){a.dispatchEvent(d);return}}this._checkHandlersProperty(a);d=typeof c=="string"?{type:c}:c;if(!d.target)d.target=
a;if(!d.type)throw Error("Event object missing 'type' property.");if(a.__eventHandlers[d.type]instanceof Array){e=a.__eventHandlers[d.type];h.unshift(d);d=0;for(var g=e.length;d<g;d++)e[d].apply(a,h)}},getMousePosition:function(a){var c={x:0,y:0};if(a.pageX)c.x=a.pageX;else if(a.clientX)c.x=a.clientX+(document.documentElement.scrollLeft?document.documentElement.scrollLeft:document.body.scrollLeft);if(a.pageY)c.y=a.pageY;else if(a.clientY)c.y=a.clientY+(document.documentElement.scrollTop?document.documentElement.scrollTop:
document.body.scrollTop);return c},getTouchEvent:function(a){return a},_checkHandlersProperty:function(b){a.isNothing(b.__eventHandlers)&&a.extend(b,{__eventHandlers:{}})},_isElement:function(a){return typeof HTMLElement==="object"?a instanceof HTMLElement:typeof a==="object"&&a.nodeType===1&&typeof a.nodeName==="string"},_isNode:function(a){return typeof Node==="object"?a instanceof Node:typeof a==="object"&&typeof a.nodeType==="number"&&typeof a.nodeName==="string"},_NATIVE_EVENTS:{click:1,dblclick:1,
mouseup:1,mousedown:1,contextmenu:1,mousewheel:1,DOMMouseScroll:1,mouseover:1,mouseout:1,mousemove:1,selectstart:1,selectend:1,keydown:1,keypress:1,keyup:1,orientationchange:1,touchstart:1,touchmove:1,touchend:1,touchcancel:1,gesturestart:1,gesturechange:1,gestureend:1,focus:1,blur:1,change:1,reset:1,select:1,submit:1,load:1,unload:1,beforeunload:1,resize:1,move:1,DOMContentLoaded:1,readystatechange:1,error:1,abort:1,scroll:1}}})})(window,Code.PhotoSwipe.Util);
...
if(this.isBusy)return!1;if(a.isNothing(this.slider.currentItem.fullSizeImage))return!1;if(!this.slider.currentItem.fullSizeImage.hasLoaded)return!1;return!0},isZoomActive:function(){return!a.isNothing(this.zoomPanRotate)},onViewportTouch:function(b){switch(b.action){case e.Actions.gestureStart:this.createZoomPanRotate();break;case e.Actions.gestureChange:this.isZoomActive()&&this.zoomPanRotate.zoomRotate(b.scale,this.settings.allowRotationOnUserZoom?b.rotation:0);break;case e.Actions.gestureEnd:this.isZoomActive()&&
this.zoomPanRotate.setStartingScaleAndRotation(b.scale,this.settings.allowRotationOnUserZoom?b.rotation:0);break;case e.Actions.touchStart:this.stopSlideshow();this.isZoomActive()&&this.zoomPanRotate.panStart(b.point);break;case e.Actions.touchMove:this.isZoomActive()&&this.zoomPanRotate.pan(b.point);break;case e.Actions.click:this.stopSlideshow();this.settings.hideToolbar?this.hide():this.toggleCaptionAndToolbar();a.Events.fire(this,{type:Code.PhotoSwipe.EventTypes.onViewportClick,target:this});
break;case e.Actions.doubleClick:if(this.isZoomActive()){var c=this;f.setTimeout(function(){c.removeZoomPanRotate()})}else{b.point.x-=a.DOM.windowScrollLeft();b.point.y-=a.DOM.windowScrollTop();var d=f.parseInt(a.DOM.getStyle(this.slider.currentItem.imageEl,"top"),10),g=f.parseInt(a.DOM.getStyle(this.slider.currentItem.imageEl,"left"),10),h=g+a.DOM.width(this.slider.currentItem.imageEl),i=d+a.DOM.height(this.slider.currentItem.imageEl);if(b.point.x<g)b.point.x=g;else if(b.point.x>h)b.point.x=h;if(b.point.y<
d)b.point.y=d;else if(b.point.y>i)b.point.y=i;this.createZoomPanRotate();this.zoomPanRotate.zoomAndPanToPoint(this.settings.doubleClickZoom,b.point)}break;case e.Actions.swipeLeft:this.stopSlideshow();this.lastShowPrevTrigger=Code.PhotoSwipe.ShowPrevTriggers.swipe;this.showNext();break;case e.Actions.swipeRight:this.stopSlideshow(),this.lastShowPrevTrigger=Code.PhotoSwipe.ShowPrevTriggers.swipe,this.showPrevious()}},onViewportFadeOut:function(){a.Events.remove(this.viewport,b.EventTypes.onFadeOut,
